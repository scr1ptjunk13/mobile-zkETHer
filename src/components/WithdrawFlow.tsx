...
export default function WithdrawFlow({ onClose }: WithdrawFlowProps) {
  ...
  const handleConfirmWithdrawal = () => {
    ...
    // Generate mock data
    const mockTxHash = `0x71d46bffa0b648`;
    const mockBlock = 18500375;
            ...
            <>
              ...
              <View style={styles.content}>
                ...
                <View style={styles.centerSection}>
                  <Text style={styles.availableNotes}>Available Notes: {mockNotes.length}</Text>
                      ...
                      <View style={styles.noteContent}>
                        ...
                        <View style={styles.noteDetails}>
                          <View style={styles.noteHeader}>
                            <Text style={styles.noteTitle}>Note #{note.id}</Text>
                            {note.isRecommended && (
                          ...
                          <Text style={styles.noteAmount}>{note.amount} ETH</Text>
                          <Text style={styles.noteReceived}>Received: {note.received}</Text>
                          <Text style={styles.notePrivacySet}>Privacy Set: {note.privacySet.toLocaleString()}</Text>
          ...
          {step === 'confirmation' && (
            <>
              ...
              <View style={styles.content}>
                {/* Withdrawal Details */}
                <View style={styles.centerSection}>
                  <Text style={styles.withdrawTitle}>Withdrawing Note #{selectedNote?.id}</Text>
                ...
                <Card style={styles.analysisCard}>
                  <CardContent>
                    ...
                    <View style={styles.analysisRow}>
                      ...
                      <Text style={styles.analysisValue}>{selectedNote?.privacySet.toLocaleString()} users</Text>
                    </View>
                ...
                <Card style={styles.completeCard}>
                  <CardContent style={styles.completeCardContent}>
                    ...
                    <View style={styles.privacyStatus}>
                      ...
                      <Text style={styles.privacyDetail}>Unlinkable from {selectedNote?.privacySet.toLocaleString()} possible deposits</Text>
                      <View style={styles.dotMatrixSmall}>
                        <DotMatrix pattern="privacy" size="small" />
                      </View>
                    </View>
